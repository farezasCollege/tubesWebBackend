...
<body>
	<section id="pertama-banget">
		<div class="container-fluid">
			...
			<div class="row row-margin" style="margin-top: 9%;">
				<div id="carousel-foto" class="carousel slide col-9" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<?php echo base_url ('assets/img/salon.jpg')?>">
						</div>
						<div class="carousel-item">
							<img src="<?php echo base_url ('assets/img/spa.jpg')?>">
						</div>
						<div class="carousel-item">
				...
				<!-- begin of login -->
				<div class="face face-front col-3 mx-auto" >
					<!-- style="padding-right: 5px !important; padding-left: 5px !important;" -->
					<div class="container2" style="margin-top: 45%;">
						<h3 >LOGIN</h3>
						<form action="" method="POST">
							<div class="form-group">
								...
								<button type="submit" class="btn btn-primary" style="background-color: #E0F5F5;">Login</button>
							</div>
						</form>
					</div>
				</div>
	...
	<section id="service" style="margin-top: 7%;">
		<h1>Our Services</h1>
	...
	<section id="about" style="margin-top: 7%;">
		<h1>About us</h1>
		<div class="row">
			<div class="container">
				<p>haha</p>		
